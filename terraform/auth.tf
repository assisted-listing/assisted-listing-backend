module "aws_cognito_user_pool"{
  ...
  user_pool_name                                     = "assisted_listing_auth_pool"
  ...
  # user_pool_domain
  domain = "assisted-listing"

  # client
  client_name                                 = "client0"
  client_allowed_oauth_flows_user_pool_client = false
  client_callback_urls                        = ["https://assisted-listing/callback"]
  client_default_redirect_uri                 = "https://assisted-listing/callback"
  ...
  # user_group
  user_group_name        = "assisted-listing"
  user_group_description = "Staying Ordernized"
  

  # ressource server
  resource_server_identifier        = "https://assisted-listing.com"
  resource_server_name              = "assisted-listing"
  resource_server_scope_name        = "scope"
  resource_server_scope_description = "I have actually done this once before"
